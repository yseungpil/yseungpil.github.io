...
|현재 게이지량|Nowgauge|현재 플레이어의 게이지량||
...
|스킬 사용|게이지를 소비해 3초간 무적이 되는 스킬을 사용한다|
...
## e. 특별공격 이후 오브젝트 상태  <a name='5-5'></a>

|오브젝트|전이상태|스테이지|
|:----:|:----:|:----:|
|플레이어|이동속도 감소|스테이지1|
|플레이어|10초간 공격 불가|스테이지2|
|플레이어|플레이어 투사체의 속도 감소|스테이지3|
|적|hp회복|스테이지4|
|적|적의 투사체 속도 증가|스테이지5|
|아이템|아이템 삭제|스테이지6|
|블록|블록 삭제|스테이지7|
...
▷ 게이지는 시간이 지남에 따라 자동으로 충전된다
  
▷ 스킬을 사용하면 게이지를 소비해 무적상태가 된다
